...
final class KnownForHorizontalViewController: ASDKViewController<ASCollectionNode>, ASCollectionDataSource, ASCollectionDelegate {
    ...
    func collectionNode(_ collectionNode: ASCollectionNode, nodeForItemAt indexPath: IndexPath) -> ASCellNode {
        if indexPath.item == 0 {
            ...
            let cellNode = KnownForCell(movie: movie)
            return cellNode
