...
final class SearchScreenNode: ASDisplayNode {
    ...
    override func layoutSpecThatFits(_ constrainedSize: ASSizeRange) -> ASLayoutSpec {
        ...
        let verticalStack = ASStackLayoutSpec(
            ...
            alignItems: .stretch,
            children: [fullwidthSearchBar, trendingLabel, verticalCollectionNode]
        )
        ...
        scrollView.layoutSpecBlock = { _, _ in
            return ASInsetLayoutSpec(insets: UIEdgeInsets(top: 100, left: 16, bottom: 0, right: 16), child: verticalStack)
        }
